...
export default function AIChatDrawer({ isOpen, onClose, selectedInternId = null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div
        onClick={onClose}
        className="animate-overlay-fade absolute inset-0 bg-slate-900/40 backdrop-blur-xs transition-opacity cursor-pointer"
      />

      <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
        <div className="animate-drawer-slide w-screen max-w-md bg-white shadow-2xl flex flex-col border-l border-slate-200">
          ...
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 text-white">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-blue-500/20 border border-blue-400/30 flex items-center justify-center p-1.5 shadow-sm">
                <img
                  src="/netsol_icon.png"
                  alt="NETSOL"
              ...
              <div>
                ...
                <p className="text-[11px] text-blue-200/70">Enterprise Assistant</p>
              </div>
            </div>
            ...
            <button
              ...
              className="group flex items-center justify-center w-8 h-8 rounded-full text-slate-300 hover:text-white bg-white/5 hover:bg-white/15 active:bg-white/25 border border-white/10 transition-all duration-150"
            >
